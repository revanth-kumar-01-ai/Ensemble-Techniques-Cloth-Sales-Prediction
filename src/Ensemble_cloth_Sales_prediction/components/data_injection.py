...
from Ensemble_cloth_Sales_prediction.entity.config_entity import DataIngestionConfig  
...
class DataIngestion:
    ...
    def fetch_data_from_database(self):
        if not os.path.exists(self.config.load_data):
            ...
            engine = create_engine(f"mysql+pymysql://root:{quote('Reva@0411')}@localhost/ClothesDB")
